...
def main():
    ...
    file_paths = [
        ...
        # "outputs/aliyun_isereal/retrival_results/jy_bigdata_sub_military_refined_question_top_percentage0.02_event.json",
        "outputs/aliyun_isereal/retrival_results/jy_bigdata_sub_military_refined_question_top_percentage0.02.json",
        "outputs/aliyun_isereal/retrival_results/jy_bigdata_sub_military_refined_question_top_percentage0.02_rerank.json",
        # "outputs/aliyun_isereal/retrival_results/jy_bigdata_sub_military_refined_question_top_percentage0.05.json",
        # "outputs/aliyun_isereal/retrival_results/jy_bigdata_sub_military_refined_question_top_percentage0.1.json",
        # "outputs/aliyun_isereal/retrival_results/jy_bigdata_sub_military_refined_question_top_percentage0.3.json",
